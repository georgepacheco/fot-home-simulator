...
const solid_client_authn_core_2 = require("@inrupt/solid-client-authn-core");
// type AccessToken = {
//     accessToken: string,
//     expires: number
// }
...
exports.Login = Login;
async function getAuthorization(user) {
...
async function generateToken(authorization, user) {
...
async function getAuthFetch(token, user) {
    // A key pair is needed for encryption.
    // This function from `solid-client-authn` generates such a pair for you.
    const dpopKey = await (0, solid_client_authn_core_1.generateDpopKeyPair)();
    ...
    const response = await fetch(tokenUrl, {
        ...
        headers: {
            ...
            dpop: await (0, solid_client_authn_core_1.createDpopHeader)(tokenUrl, 'POST', dpopKey),
        },
    ...
    const authFetch = await (0, solid_client_authn_core_2.buildAuthenticatedFetch)(accessToken, { dpopKey });
    return authFetch;
}
